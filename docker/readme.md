...
For English version follow the link: [docker/readme.en.md](readme.en.md)
...
Можно скачать уже собранный образ [👉 по ссылке](https://any.hayazg.net/xray-mikrotik-26.2.9-arm64.tar).
Бывают ситуации, что у mikrotik нет доступа к github.com или просто, для надежности, хотите держать файл образа на USB-флешке в Mikrotik. Тогда вам нужно самостоятельно сгенерировать tar-архив образа. Генерировать образ требуется и в случае, когда вы хотите кастомизировать Image (что-то  хотите поменять в Dockerfile или start.sh) и пересобрать образ.
